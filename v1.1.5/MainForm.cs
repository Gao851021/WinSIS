...
namespace WinSIS
{
    public partial class MainForm : Form
    {
        ...
        private void MainForm_Shown(object sender, EventArgs e)
        {
            ...
            lbl_progCPU.Text = LangValue[162]; // CPU progress
            lbl_progRAM.Text = LangValue[163]; // RAM progress
            lbl_progSpace.Text = LangValue[164]; // Space progress
        ...
        private void SaveToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            if (save.ShowDialog() == DialogResult.OK)
            {
                try
                {
                    ...
                    sw.WriteLine("\t--------------------------------");
                    sw.WriteLine("\tWinSIS | Version 1.1.5");
